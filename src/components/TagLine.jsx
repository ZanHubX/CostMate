const TagLine = () => {
  ...
  // ];
  return (
    <p className="text-slate-100 text-center px-6 font-logo align-center justify-center text-xs sm:text-sm md:text-sm lg:text-xs py-3 bg-gradient-to-tr from-slate-800 to-slate-900">
